...
public class CMMember extends CMObject {
	private Vector<kr.ac.konkuk.ccslab.cm.entity.CMUser> m_memberList;
	...
	public CMMember()
	{
		...
		m_memberList = new Vector<kr.ac.konkuk.ccslab.cm.entity.CMUser>();
	}
	 ...
	 */
	public synchronized boolean addMember(kr.ac.konkuk.ccslab.cm.entity.CMUser user)
	{
	 ...
	 */
	public synchronized boolean removeMember(kr.ac.konkuk.ccslab.cm.entity.CMUser user)
	{
		Iterator<kr.ac.konkuk.ccslab.cm.entity.CMUser> iter = m_memberList.iterator();
		int nRemovedNum = 0;
		while(iter.hasNext())
		{
			kr.ac.konkuk.ccslab.cm.entity.CMUser tuser = iter.next();
	...
	public synchronized boolean removeMemberObject(kr.ac.konkuk.ccslab.cm.entity.CMUser user)
	{
		Iterator<kr.ac.konkuk.ccslab.cm.entity.CMUser> iter = m_memberList.iterator();
		int nRemovedNum = 0;
	 ...
	 */
	public synchronized boolean isMember(kr.ac.konkuk.ccslab.cm.entity.CMUser user)
	{
		Iterator<kr.ac.konkuk.ccslab.cm.entity.CMUser> iter = m_memberList.iterator();
		while(iter.hasNext())
		{
	 ...
	 */
	public synchronized kr.ac.konkuk.ccslab.cm.entity.CMUser findMember(String name)
	{
		kr.ac.konkuk.ccslab.cm.entity.CMUser tuser;
		Iterator<kr.ac.konkuk.ccslab.cm.entity.CMUser> iter = m_memberList.iterator();
		while(iter.hasNext())
		{
			tuser = iter.next();
	 ...
	 */
	public synchronized Vector<kr.ac.konkuk.ccslab.cm.entity.CMUser> getAllMembers()
	{
		return m_memberList;
	}
