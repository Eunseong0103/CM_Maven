...
public class CMUserEvent extends CMEvent {
	...
	private Vector<kr.ac.konkuk.ccslab.cm.event.CMUserEventField> m_eventFieldList;
	...
	public CMUserEvent()
	{
		...
		m_strID = "defaultID";
		m_eventFieldList = new Vector<kr.ac.konkuk.ccslab.cm.event.CMUserEventField>();
	}
	 ...
	 */
	public Vector<kr.ac.konkuk.ccslab.cm.event.CMUserEventField> getAllEventFields()
	{
	...
	{
		kr.ac.konkuk.ccslab.cm.event.CMUserEventField uef = null;
		uef = findEventField(nDataType, strFieldName);
		if(uef == null)
		{
			uef = new kr.ac.konkuk.ccslab.cm.event.CMUserEventField();
	 ...
	 */
	public kr.ac.konkuk.ccslab.cm.event.CMUserEventField findEventField(int nDataType, String strFieldName)
	{
		kr.ac.konkuk.ccslab.cm.event.CMUserEventField uef = null;
		boolean bFound = false;
		Iterator<kr.ac.konkuk.ccslab.cm.event.CMUserEventField> iterEventFieldList = m_eventFieldList.iterator();
