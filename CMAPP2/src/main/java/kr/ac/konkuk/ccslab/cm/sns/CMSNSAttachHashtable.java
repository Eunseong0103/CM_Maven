...
public class CMSNSAttachHashtable extends CMObject {
	...
	private Hashtable<String, kr.ac.konkuk.ccslab.cm.sns.CMSNSAttachList> m_attachHashtable; // key is the requester name
	
	public CMSNSAttachHashtable()
	{
		//m_attachMap = new HashMap<String, CMSNSAttachList>();
		m_attachHashtable = new Hashtable<String, kr.ac.konkuk.ccslab.cm.sns.CMSNSAttachList>();
	}
	
	public kr.ac.konkuk.ccslab.cm.sns.CMSNSAttachList findSNSAttachList(String strUserName)
	{
		//CMSNSAttachList attachList = m_attachMap.get(strUserName);
		kr.ac.konkuk.ccslab.cm.sns.CMSNSAttachList attachList = m_attachHashtable.get(strUserName);
		return attachList;
	}
