...
public class CMServer extends CMServerInfo {
	...
	private Vector<kr.ac.konkuk.ccslab.cm.entity.CMSession> m_sessionList;	// only 4 client
	...
	public CMServer()
	{
		...
		m_sessionList = new Vector<kr.ac.konkuk.ccslab.cm.entity.CMSession>();
	}
	...
	{
		kr.ac.konkuk.ccslab.cm.entity.CMSession tSession = null;
		boolean bFound = false;
		Iterator<kr.ac.konkuk.ccslab.cm.entity.CMSession> iter = m_sessionList.iterator();
	...
	public synchronized boolean addSession(kr.ac.konkuk.ccslab.cm.entity.CMSession session)
	{
	...
	public synchronized kr.ac.konkuk.ccslab.cm.entity.CMSession findSession(String strSessionName)
	{
		kr.ac.konkuk.ccslab.cm.entity.CMSession tSession = null;
		boolean bFound = false;
		Iterator<kr.ac.konkuk.ccslab.cm.entity.CMSession> iter = m_sessionList.iterator();
